...
const config_CLUA = {
    ...
    user: "ax",
    password: "465666",
    database: 'CL_UK_Retail_Live',
    connectionString: "Driver={SQL Server Native Client 10.0};Server=#{server}\\sql;Database=#{database};Uid=#{user};Pwd=#{password};",
    PoolTimeout: 199999, //3.3 min
    connectionTimeout: 1800000,// 10 min
    requestTimeout: 2999999, //50 min
    options: {
